...
| Gate 6 (assemble automation, hardening, Lighthouse) | **In progress (approved Sep 23)** — Assemble flow first: KML at creation, data-derived assembly checklist on Overview (`lib/assembly.ts`), one-click Generate remaining after style lock. Hardening, Lighthouse budget, ops docs to follow. Disclaimer wording attorney-approved. |
